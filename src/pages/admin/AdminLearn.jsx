...
//   Loader2, BookOpen, Atom, Image as ImageIcon
// } from 'lucide-react';
// import { adminLearnApi } from '../../api/adminLearnApi';

// const AdminLearn = () => {
//   const [activeTab, setActiveTab] = useState('articles'); // 'articles' or 'values'
...
//                  <div key={article.id} className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden group hover:border-brand-glow/30 transition-all">
//                     <div className="h-40 bg-dark-950 relative">
//                        <img src={article.image_url} alt={article.title} className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity" />
...
//                        </div>
//                        <Input label="Image URL" value={articleForm.image_url} onChange={e => setArticleForm({...articleForm, image_url: e.target.value})} icon={ImageIcon} />
//                     </form>
//                  ) : (
