...
// import { Plus, Search, Edit2, Trash2, Package, Filter, Loader2 } from 'lucide-react';
...
//     if (!window.confirm("Are you sure? This will delete the product and all variants.")) return;
//     try {
...
//   if (loading) return <div className="p-10 flex justify-center"><Loader2 className="animate-spin text-brand-glow" /></div>;
...
//         </div>
//         <Link to="/admin/products/new" className="px-6 py-3 bg-brand-glow text-dark-900 font-bold rounded-xl flex items-center gap-2 hover:brightness-110 transition-all">
//            <Plus size={18} /> Add Product
//         </Link>
//       </div>

//       {/* Toolbar */}
//       <div className="bg-dark-900 border border-white/10 rounded-2xl p-4 flex gap-4">
...
//           />
//         </div>
//         <button className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-slate-400 hover:text-white flex items-center gap-2">
...
//                       <div className="w-12 h-12 rounded-lg bg-dark-800 border border-white/10 overflow-hidden">
...
//                   <td className="p-4 text-sm text-brand-glow font-mono">
//                      {minPrice === maxPrice ? `$${minPrice}` : `$${minPrice} - $${maxPrice}`}
//                   </td>
//                   <td className="p-4 text-sm">
//                      <span className={`px-2 py-1 rounded-md text-xs font-bold ${totalStock < 10 ? 'bg-red-500/10 text-red-400' : 'bg-green-500/10 text-green-400'}`}>
//                         {totalStock} Units
//                      </span>
//                   </td>
//                   <td className="p-4 text-right">
//                     <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
//                       <Link to={`/admin/products/edit/${product.slug}`} className="p-2 bg-blue-500/20 text-blue-400 rounded-lg hover:bg-blue-500/30">
//                         <Edit2 size={16} />
//                       </Link>
//                       <button onClick={() => handleDelete(product.id)} className="p-2 bg-red-500/20 text-red-400 rounded-lg hover:bg-red-500/30">
//                         <Trash2 size={16} />
//                       </button>
//                     </div>
//                   </td>
