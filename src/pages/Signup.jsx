...
// // import { Lock, Mail, User, ArrowRight, Beaker } from 'lucide-react';
...
// //               type="submit" 
// //               disabled={loading}
// //               className="w-full py-4 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold tracking-wide hover:shadow-[0_0_20px_rgba(147,51,234,0.4)] transition-all flex items-center justify-center gap-2 group mt-6"
// //             >
// //               {loading ? <span className="animate-pulse">Processing...</span> : <>REGISTER ACCOUNT <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" /></>}
// //             </button>
// //           </form>
...
// import { Link, useNavigate } from 'react-router-dom';
// import { motion } from 'framer-motion';
// import { Lock, Mail, User, ArrowRight, Beaker, Phone, Calendar, MapPin, AlertCircle } from 'lucide-react';
// import { useAuth } from '../context/AuthContext';
