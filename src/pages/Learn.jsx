...
//   {
//     id: 1,
//     title: "Understanding 7-Hydroxymitragynine",
//     excerpt: "Why the specific alkaloid Cloud 7-OH offers a cleaner, more potent experience than traditional leaf powder.",
//     readTime: "5 min read",
//     category: "Science",
...
//     excerpt: "A look inside our cold-press technology and how we preserve alkaloid integrity during isolation.",
//     readTime: "8 min read",
//     category: "Technology",
...
//   {
//     id: 3,
//     title: "Dosing Guide for Beginners",
//     excerpt: "How to safely find your optimal dose using our Tablet and Liquid formulations.",
//     readTime: "3 min read",
//     category: "Usage",
...
//   {
//     id: 4,
//     title: "Kratom vs. Cloud 7-OH Isolate",
//     excerpt: "Comparing the full spectrum leaf effects against the targeted precision of pure isolates.",
//     readTime: "6 min read",
//     category: "Comparison",
...
// const Learn = () => {
//   return (
//     <div className="min-h-screen pt-32 pb-20 bg-dark-900 text-white">
//       <div className="max-w-7xl mx-auto px-6">
        
//         {/* Header */}
//         <div className="text-center mb-20">
//           <h1 className="text-5xl font-bold mb-4">Research Hub</h1>
//           <p className="text-slate-400">Educational resources for the modern researcher.</p>
//         </div>
...
//         className="group relative h-80 rounded-3xl overflow-hidden border border-white/10 cursor-pointer"
//     >
//         {/* Background Gradient (Visible on Hover) */}
//         <div className={`absolute inset-0 bg-gradient-to-br ${article.color} opacity-0 group-hover:opacity-20 transition-opacity duration-500`}></div>
        
//         {/* Background Glow Blob */}
//         <div className={`absolute -bottom-20 -right-20 w-64 h-64 rounded-full bg-gradient-to-r ${article.color} blur-[100px] opacity-20 group-hover:opacity-40 transition-opacity duration-500`}></div>

//         <div className="relative z-10 p-8 h-full flex flex-col justify-between">
//             <div>
//                 <div className="flex justify-between items-start mb-4">
//                     <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-bold uppercase tracking-wider text-slate-300 group-hover:bg-white group-hover:text-black transition-colors">
//                         {article.category}
//                     </span>
...
//                     </div>
//                 </div>
//                 <h3 className="text-2xl font-bold mb-2 group-hover:text-brand-glow transition-colors">{article.title}</h3>
//                 <p className="text-slate-400 text-sm leading-relaxed">{article.excerpt}</p>
//             </div>

//             <div className="flex items-center gap-2 text-sm font-bold text-slate-300 group-hover:translate-x-2 transition-transform">
//                 READ ARTICLE <ArrowRight size={16} className="text-brand-glow" />
//             </div>
//         </div>
//     </motion.div>
// );
