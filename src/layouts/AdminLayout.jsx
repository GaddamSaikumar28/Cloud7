...
//   LogOut, ShieldAlert, ChevronRight, Menu, 
//   Settings2,ClipboardList,Wallet,MessageSquare,Microscope,LayoutTemplate,Flag
// } from 'lucide-react';
...
//   return (
//     <div className="min-h-screen bg-dark-950 flex text-white font-sans selection:bg-brand-glow selection:text-black">
...
//           <button onClick={logout} className="flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-500/10 rounded-xl w-full transition-all">
//             <LogOut size={20} />
...
//         <header className="h-20 border-b border-white/5 bg-dark-900/50 backdrop-blur-md flex items-center justify-between px-8">
...
//             </div>
//             <div className="w-10 h-10 rounded-full bg-gradient-to-br from-brand-glow to-purple-600 border-2 border-dark-800" />
//           </div>
//         </header>
