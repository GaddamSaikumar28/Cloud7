    ...
    <div className="relative bg-dark-950 overflow-hidden min-h-screen">
      ...
      <section className="relative z-10 w-full min-h-[110vh] flex flex-col items-center pt-32 pb-20">
        ...
        >
            <Link 
              to={content.cta_link} 
              className="group relative inline-flex items-center justify-center px-10 py-5 font-bold text-black transition-all duration-300 bg-brand-glow/90 rounded-2xl hover:scale-105 active:scale-95 shadow-[0_0_40px_-10px_rgba(14,165,233,0.5)] hover:shadow-[0_0_60px_-10px_rgba(14,165,233,0.8)] backdrop-blur-md"
            >
